...
const Header = () => {
  ...
  const { isDarkMode, setTheme, isSystemPreference, isTransitioning } = useDarkMode();
  ...
  useEffect(() => {
    const handleClickOutside = (event) => {
      if (showThemeMenu && !event.target.closest(`.${styles.themeToggleContainer}`)) {
        setShowThemeMenu(false);
      }
    };
      ...
      <div className={styles.headerContainer}>
        ...
        <nav className={`${styles.nav} ${isMobileMenuOpen ? styles.navOpen : ''}`}>
          ...
          <div className={styles.themeToggleContainer}>
            <button
              className={`${styles.darkModeToggle} ${isTransitioning ? styles.transitioning : ''}`}
              ...
              <div className={styles.themeMenu}>
                ...
                >
                  <svg viewBox="0 0 24 24" fill="currentColor" width="16" height="16">
                    <path d="M12 2.25a.75.75 0 0 1 .75.75v2.25a.75.75 0 0 1 -1.5 0V3a.75.75 0 0 1 .75 -0.75ZM7.5 12a4.5 4.5 0 1 1 9 0 4.5 4.5 0 0 1 -9 0ZM18.894 6.166a.75.75 0 0 0 -1.06 -1.06l-1.591 1.59a.75.75 0 1 0 1.06 1.061l1.591 -1.59ZM21.75 12a.75.75 0 0 1 -0.75.75h-2.25a.75.75 0 0 1 0 -1.5H21a.75.75 0 0 1 .75.75ZM17.834 18.894a.75.75 0 0 0 1.06 -1.06l-1.59 -1.591a.75.75 0 0 1 0 -1.061l1.59 1.591ZM12 18a.75.75 0 0 1 .75.75V21a.75.75 0 0 1 -1.5 0v-2.25A.75.75 0 0 1 12 18ZM6.166 17.834a.75.75 0 0 0 -1.06 1.06l1.591 1.59a.75.75 0 0 0 1.06 -1.061l-1.591 -1.59ZM2.25 12a.75.75 0 0 1 .75 -.75H5.25a.75.75 0 0 1 0 1.5H3a.75.75 0 0 1 -.75 -.75ZM6.166 6.166a.75.75 0 0 0 1.06 -1.06L5.636 3.515a.75.75 0 0 0 -1.061 1.06l1.591 1.591Z"/>
                  </svg>
                  Light
                </button>
                <button 
